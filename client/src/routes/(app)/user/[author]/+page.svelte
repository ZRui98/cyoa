<script lang="ts">
    ...
    let adventures = [
        {name: 'sample-story', description:'summary of the story and what it\'s about [test](https://google.com). Try again here? [test](https://google.com)', count: 0},
        {name: 'sample-story', description:'[test](https://google.com)', count: 0},
        {name: 'sample-story', description:'summary of the story and what it\'s about: [link here](https://google.com)', count: 0},
        {name: 'sample-story', description: bio, count: 0},
        {name: 'sample-story', description:'summary of the story and what it\'s about', count: 0}
    ]
</script>
...
<div id="container">
    {#each adventures as adventure}
        <Adventure name={adventure.name} author={name} description={adventure.description} count={adventure.count}/>
    {/each}
</div>
